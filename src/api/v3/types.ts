...
export const PERMS = {
  ...
  // v6 — training / dashboards / exports / AI
  trainingRead: 'training.read',
  trainingManage: 'training.manage',
  trainingPublish: 'training.publish',
  trainingAttendance: 'training.attendance.record',
  trainingAssess: 'training.assess',
  trainingSignoff: 'training.signoff',
  studentsSelf: 'students.self',
  certificatesIssue: 'certificates.issue',
  certificatesRevoke: 'certificates.revoke',
  dashboardsWorkshop: 'dashboards.workshop',
  dashboardsInventoryFinance: 'dashboards.inventory-finance',
  dashboardsTraining: 'dashboards.training',
  dashboardsAiData: 'dashboards.ai-data',
  exportsRead: 'exports.read',
  exportsCreate: 'exports.create',
  predictionsReorderRead: 'predictions.reorder.read',
  predictionsRiskRead: 'predictions.risk.read',
  predictionsReorderDecide: 'predictions.reorder.decide',
  predictionsRiskDecide: 'predictions.risk.decide',
} as const
